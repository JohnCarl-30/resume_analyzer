 ...
 * be rendered.
 *
 * - Steps 2 and 3: the back button lives in the AnalysisWizard header
 *   (`{step > 1 && <button>...{backLabel}</button>}`).
 * - Step 4: the wizard header renders "Back to Resume".
 *
 * Testing strategy:
 * - Steps 2, 3, and 4 are tested by rendering AnalysisWizard and navigating to
...
describe("Feature: resume-editor-flow, Property 15: Back button presence", () => {
  it(
    ...
    async () => {
      // --- Step 2: render AnalysisWizard and navigate to step 2 ---
      ...
      // --- Step 3: render AnalysisWizard and navigate to step 3 ---
      ...
      // --- Step 4: render AnalysisWizard and navigate to step 4 ---
